...
create table employer (username varchar(30), email varchar(30), password varchar(30)); /* we use this sql statement for creating a table in database with the name employer. This table will have two columns the email and password */
...
insert into employer
	values ('kitsos','kitsos@kitsos.com', 'Kitsos1'); /* we use this sql statement to load data into our table */
insert into employer
	values ('mhtsos','mhtsos@mhtsos.com', 'Mhtsos1');
